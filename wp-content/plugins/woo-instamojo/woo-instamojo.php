    ...
    class WC_Instamojo extends WC_Payment_Gateway{
        ...
        public function init_form_fields(){
            ...
            $this->form_fields = array(
                ...
                'payment_link' =>array(
                    'title' => __('Instamojo Product Link*','instamojo' ),
                    'type' => 'text',
                    'default' => '',
        ...
        **/
        function process_payment($order_id){
            ...
            $delivery_name = substr(trim($order->billing_first_name) . trim($order->billing_last_name), 0, 20);
            ...
            $link.="&data_amount=$amount&data_name=$delivery_name&data_email=$encoded_email&data_phone=$encoded_number&{$custom_field}=$order_id&data_sign=$str";
