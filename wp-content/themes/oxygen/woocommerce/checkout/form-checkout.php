...
if ( ! $checkout->enable_signup && ! $checkout->enable_guest_checkout && ! is_user_logged_in() ) {
	...
	# start: modified by Arlind Nushi
	echo '<div class="col-sm-12 checkout-login-required">';
	echo apply_filters( 'woocommerce_checkout_must_be_logged_in_message', __( 'You must be logged in to checkout.', 'oxygen' ) );
	echo '</div>';
	# end: modified by Arlind Nushi
	return;
}
