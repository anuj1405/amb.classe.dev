...
<div class="row">
	<div class="col-lg-12">
		<p class="cart-empty"><?php _e( 'Your cart is currently empty.', 'oxygen' ) ?></p>
		
		<?php do_action( 'woocommerce_cart_is_empty' ); ?>
		
		<p class="return-to-shop"><a class="button wc-backward" href="<?php echo apply_filters( 'woocommerce_return_to_shop_redirect', get_permalink( wc_get_page_id( 'shop' ) ) ); ?>"><?php _e( 'Return To Shop', 'oxygen' ) ?></a></p>
	</div>
</div>
