...
$catalog_orderby = apply_filters( 'woocommerce_catalog_orderby', array(
	'menu_order' => __( 'Default sorting', 'oxygen' ),
	'popularity' => __( 'Sort by popularity', 'oxygen' ),
	'rating'     => __( 'Sort by average rating', 'oxygen' ),
	'date'       => __( 'Sort by newness', 'oxygen' ),
	'price'      => __( 'Sort by price: low to high', 'oxygen' ),
	'price-desc' => __( 'Sort by price: high to low', 'oxygen' )
) );
...
$selected_sorting = __('Default sorting', 'oxygen');

foreach ( $catalog_orderby as $id => $name )
{
	if($id == lab_get('orderby'))
...
<div class="btn-group">
	...
	foreach ( $catalog_orderby as $id => $name ):
		...
		?>
		<li<?php echo $id == lab_get('orderby') ? ' class="active"' : ''; ?>>
