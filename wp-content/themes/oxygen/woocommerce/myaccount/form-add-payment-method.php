...
<form id="add_payment_method" method="post">
	<div id="payment">
		<ul class="payment_methods methods">
			<?php
				if ( $available_gateways = WC()->payment_gateways->get_available_payment_gateways() ) {
					...
					echo '<p>' . __( 'Sorry, it seems that there are no payment methods which support adding a new payment method. Please contact us if you require assistance or wish to make alternate arrangements.', 'oxygen' ) . '</p>';
		...
		<div class="form-row">
			...
			<input type="submit" class="button alt" id="place_order" value="<?php _e( 'Add Payment Method', 'oxygen' ); ?>" />
