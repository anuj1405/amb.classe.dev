...
$page_title = ( $load_address === 'billing' ) ? __( 'Billing Address', 'oxygen' ) : __( 'Shipping Address', 'oxygen' );
					...
					<div class="myaccount-tab current" id="my-address">
						...
						<?php else : ?>
							...
							<form method="post" class="checkout-form-fields">
								...
								<p>
									<input type="submit" class="button btn btn-default up" name="save_address" value="<?php _e( 'Save Address', 'oxygen' ); ?>" />
