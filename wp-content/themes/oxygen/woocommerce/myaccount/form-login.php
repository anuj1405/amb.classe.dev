		...
		<div class="white-block block-pad">
			...
			<form method="post" class="login">
				...
				<p class="form-row form-row-wide">
					<label for="username">
						<?php _e( 'Username or email address', 'oxygen' ); ?>
				...
				<p class="form-row">
					...
					<input type="submit" class="button btn-default btn full-width-btn up" name="login" value="<?php _e( 'Login', 'oxygen' ); ?>" />
					...
					<a href="<?php echo esc_url( wc_lostpassword_url() ); ?>" class="lost-password"><?php _e( 'Lost your password?', 'oxygen' ); ?></a>
				</p>
		...
		<div class="block-pad white-block">
			...
			<form method="post" class="register">
				...
				<div style="left:-999em; position:absolute;">
					<label for="trap"><?php _e( 'Anti-spam', 'oxygen' ); ?></label>
				...
				<p class="form-row">
					...
					<input type="submit" class="button btn-default btn full-width-btn up" name="register" value="<?php _e( 'Register', 'oxygen' ); ?>" />
				</p>
