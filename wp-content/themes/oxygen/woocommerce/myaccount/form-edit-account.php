					...
					<div class="myaccount-tab current" id="edit-account">
						...
						<form action="" method="post" class="checkout-form-fields">
							...
							<p class="form-row form-row-first">
								<label for="account_first_name"><?php _e( 'First name', 'oxygen' ); ?> <span class="required">*</span></label>
							...
							<p class="form-row form-row-last">
								<label for="account_last_name"><?php _e( 'Last name', 'oxygen' ); ?> <span class="required">*</span></label>
								<input type="text" class="input-text" name="account_last_name" id="account_last_name" value="<?php esc_attr_e( $user->last_name ); ?>" />
							</p>
							<p class="form-row form-row-wide">
								<label for="account_email"><?php _e( 'Email address', 'oxygen' ); ?> <span class="required">*</span></label>
								<input type="email" class="input-text" name="account_email" id="account_email" value="<?php esc_attr_e( $user->user_email ); ?>" />
							</p>
							<p class="form-row form-row-thirds">
								<label for="password_current"><?php _e( 'Current Password (leave blank to leave unchanged)', 'oxygen' ); ?></label>
							...
							<p><input type="submit" class="button btn btn-default up" name="save_account_details" value="<?php _e( 'Save changes', 'oxygen' ); ?>" /></p>
