	...
	<div class="row white-row">
		...
		<div class="col-sm-6">
			...
			<div class="summary entry-summary">
				...
				?>
				<div>
				<hr style="border-bottom: 1px solid #d3d4d4;" >
				<div class="text-center product-avail">
			<p>	<img src="http://shop.ambclasse.com/wp-content/uploads/2016/09/call_icon.png">&nbsp; 9953-147-642 (Mon - Fri 9:00am IST - 6:00pm IST)</p>
			<p> Free Standard shipping on all orders. </p>
			<p> <img src=" http://shop.ambclasse.com/wp-content/uploads/2016/09/booking_icon.png"> Availability in Stores. </p>
				</div>
				 </div>
